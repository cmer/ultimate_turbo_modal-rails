...
module UltimateTurboModal::Flavors
  class Tailwind3 < UltimateTurboModal::Base
    DIALOG_CLASSES = "relative group z-50 p-0 border-none bg-transparent max-w-full max-h-full w-auto h-auto m-0 backdrop:bg-gray-900 backdrop:bg-opacity-50 dark:backdrop:bg-opacity-80"
